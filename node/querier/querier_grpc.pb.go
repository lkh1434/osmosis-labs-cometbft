...
const (
	CosmosIndexer_GetBlock_FullMethodName           = "/querier.CosmosIndexer/GetBlock"
	CosmosIndexer_GetBlockStreamFrom_FullMethodName = "/querier.CosmosIndexer/GetBlockStreamFrom"
)
...
func (c *cosmosIndexerClient) GetBlock(ctx context.Context, in *GetBlockRequest, opts ...grpc.CallOption) (*GetBlockResponse, error) {
	...
	err := c.cc.Invoke(ctx, CosmosIndexer_GetBlock_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cosmosIndexerClient) GetBlockStreamFrom(ctx context.Context, opts ...grpc.CallOption) (CosmosIndexer_GetBlockStreamFromClient, error) {
	stream, err := c.cc.NewStream(ctx, &CosmosIndexer_ServiceDesc.Streams[0], CosmosIndexer_GetBlockStreamFrom_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func _CosmosIndexer_GetBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CosmosIndexer_GetBlock_FullMethodName,
	}
